...
public class DatabaseEnrollment extends Database{
    ...
    public static Enrollment readEnrollment(String id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                data = new Enrollment(idDB, enrollmentDate, courseTitle, certificateID);
            }
    ...
    public static boolean createEnrollment(String userEmail, String courseTitle) throws AlreadyExistsException {
        ...
        if(checkIfExists(userEmail, courseTitle) == true){
            throw new AlreadyExistsException("The enrollment with the combination \"" + userEmail + "\" and \"" + courseTitle + "\" already exists");
        }
    ...
    public static boolean addCertificate(Certificate certificateID) {

        String SQL = "UPDATE [Enrollment] SET certificateID = '" + certificateID + "'";
    ...
    public static ArrayList<Enrollment> getUserEnrollments(String userEmail) {
        ...
        try{
            ...
            while (rs.next()) {
                ...
                data.add(new Enrollment(idDB, enrollmentDate, courseTitle, certificateID));
            }
